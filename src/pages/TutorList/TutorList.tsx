  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-left text-gray-800 mb-10">
          Gia sư Hiện tại của bạn
        </h1>

        {myCurrentTutors.length > 0 ? (
          <div className="bg-gradient-to-bl from-gray-100 to-gray-300 p-6 rounded-xl shadow-md border border-gray-200">
